...
public class MySaleRecyclerViewAdapter extends RecyclerViewAdapterWithFilter<MySaleRecyclerViewAdapter.ViewHolder, ProductData> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_item_coffee_sale_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final ProductData value) {
        ...
        if (prodTransactionDataHashMap.get(value.getProdPPID())!= null) {
            ...
            holder.mSaleQuantity1TextView.setText(String.valueOf(prodTransactionDataHashMap.get(value.getProdPPID()).getCurICount()));
            holder.mSaleQuantity2TextView.setText(String.valueOf(prodTransactionDataHashMap.get(value.getProdPPID()).getCurSCount()));
        } else {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ProductData productData : mListHolder) {
                        ...
                        if (productData.getName().toLowerCase().contains(charString) || productData.getBCode().toLowerCase().contains(charString)) {
